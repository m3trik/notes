...
# ======================================================================
>>>>>>> e3481c05b69d1ce2a215ddf6464a85f0773d55d7
#	NETWORK:
# ======================================================================
...
sudo systemctl start smbd nmbd #start service
#reset widows share
...
'''
sudo apt update && apt install -y php-smbclient #install smbclient
#get version
php -version
#
...
#set strict Transport Security HTTP Header
sudo nano /etc/apache2/sites-available/default-ssl.conf #Add the following snippet of code to the SSL.conf
'''Header always add Strict-Transport-Security "max-age=15768000; includeSubDomains; preload"
'''
#configure APCu memory cache
sudo nano /var/www/nextcloud/config/config.php #Add the following line of text to the config.php
